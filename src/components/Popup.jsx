...
const Popup = ({ isOpen, onClose }) => {
  ...
  const handleWhatsApp = () => {
    const message = `Hi! I'm interested in the 20% discount offer at Oceanic Welness Spa. Can you please provide more details?`;
    ...
    >
      ...
      <div className={`relative bg-white rounded-lg shadow-lg max-w-xs w-full mx-4 transform transition-all duration-300 ${
        ...
        <div className="p-6 text-center">
          ...
          {/* Discount Offer */}
          <div className="mb-6">
            <div className="text-2xl font-bold text-primary mb-2">30% OFF</div>
            <p className="text-sm text-gray-600">
              Book now and save 30% on all services
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={handleCall}
              className="w-full bg-primary hover:bg-accent text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
            >
